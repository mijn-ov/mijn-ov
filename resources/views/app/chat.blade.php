...
@section('content')
    ...
    <section class="flex flex-col justify-between content-screen">
        ...
        <div>
            ...
            <div id="help-box" class="flex flex-col w-full justify-center items-center" @if($messages === null) style="transform: translateY(200px)" @endif>
                ...
                <div class="help-box flex flex-row justify-between items-center p-3">
                    <div class="flex flex-row gap-4 items-center">
                        <form class="btn-outline-stylish flex flex-row items-center" style="transform: translateY(8px)" action="{{ route('chat.emissions') }}" method="POST">
                            @csrf
